      ...
      <nav id='home'>
        <div className="navbar bg-base-300">
          <div className="navbar-start pb-1 ">
            ...
            <a href="/" className="btn btn-ghost text-3xl px-5 font-serif">Datinger</a>
          </div>
          <div className="navbar-center hidden lg:flex pb-1">
            <ul className="menu font-medium menu-horizontal rounded-xl items-center text-base gap-5">
              ...
              <li><a className='rounded-lg' href="/user-profile">User Profile</a></li>
              <li><a className='rounded-lg' href="/matches">Matches</a></li>
            </ul>
          </div>
